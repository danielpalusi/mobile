window.onload = function(){
        ...
        var kategori = ["Action","Adventure","Romance"];
    	...
    	{
        	author.innerHTML +='<li><br><span><img src=\"https://cdn1.iconfinder.com/data/icons/user-pictures/100/male3-128.png" class="wiw" alt=""></span><span> '+(nama[i])+' </span></li>';
    	};

    	var topbuku =document.getElementById("tetew2");
    	for(j=0;j< buku.length;j++){
    		topbuku.innerHTML += '<li><br><div class="row"><div class="col-md-1"><img src=\"https://about.canva.com/wp-content/uploads/sites/3/2015/01/children_bookcover.png" class="book" alt="Some picture"></div><div class="col-md-2"><b>'+(buku[j][0])+'</b><p>by '+(buku[j][1])+'</p></div></div></li>';
    	};

        var kat =document.getElementById("kategoriku");
        for(k=0;k< kategori.length;k++){
            kat.innerHTML += '<li>'+(kategori[k])+'</li>';
        };

        var ev =document.getElementById("everythings");
        for(l=0;l< tabBook.length;l++){
            ev.innerHTML += '<div class="col-md-4 col-sm-6"><div class="card"><img class="card-img-top" src=\"'+(tabBook[l][0])+'" id="cimg" alt="Card image cap"><div class="card-body"><h5 class="card-title">'+(tabBook[l][1])+'</h5><p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p><p>Rate: '+(tabBook[l][3])+'</p><p>'+(tabBook[l][4])+' voters</p><button type="button" class="btn btn-info" onClick="like(this)">Like!</button></div></div></div>';
        };

        var bu =document.getElementById("onlyBusiness");
        for(l=0;l< tabBook.length;l++){
            if (tabBook[l][2]=='Business'){
            bu.innerHTML += '<div class="col-md-4 col-sm-6"><div class="card"><img class="card-img-top" src=\"'+(tabBook[l][0])+'" id="cimg" alt="Card image cap"><div class="card-body"><h5 class="card-title">'+(tabBook[l][1])+'</h5><p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p><p>Rate: '+(tabBook[l][3])+'</p><p>'+(tabBook[l][4])+' voters</p><button type="button" class="btn btn-info" onClick="like(this)">Like!</button></div></div></div>';
            }
        };
        ...
        for(l=0;l< tabBook.length;l++){
            ...
            sc.innerHTML += '<div class="col-md-4 col-sm-6"><div class="card"><img class="card-img-top" src=\"'+(tabBook[l][0])+'" id="cimg" alt="Card image cap"><div class="card-body"><h5 class="card-title">'+(tabBook[l][1])+'</h5><p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p><p>Rate: '+(tabBook[l][3])+'</p><p>'+(tabBook[l][4])+' voters</p><button type="button" class="btn btn-info" onClick="like(this)">Like!</button></div></div></div>';
            }
        };
        ...
        for(l=0;l< tabBook.length;l++){
            ...
            fi.innerHTML += '<div class="col-md-4 col-sm-6"><div class="card"><img class="card-img-top" src=\"'+(tabBook[l][0])+'" id="cimg" alt="Card image cap"><div class="card-body"><h5 class="card-title">'+(tabBook[l][1])+'</h5><p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p><p>Rate: '+(tabBook[l][3])+'</p><p>'+(tabBook[l][4])+' voters</p><button type="button" class="btn btn-info" onClick="like(this)">Like!</button></div></div></div>';
            }
        };
        ...
        for(l=0;l< tabBook.length;l++){
            ...
            ph.innerHTML += '<div class="col-md-4 col-sm-6"><div class="card"><img class="card-img-top" src=\"'+(tabBook[l][0])+'" id="cimg" alt="Card image cap"><div class="card-body"><h5 class="card-title">'+(tabBook[l][1])+'</h5><p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p><p>Rate: '+(tabBook[l][3])+'</p><p>'+(tabBook[l][4])+' voters</p><button type="button" class="btn btn-info" onClick="like(this)">Like!</button></div></div></div>';
            }
        };
        ...
        for(l=0;l< tabBook.length;l++){
            ...
            bi.innerHTML += '<div class="col-md-4 col-sm-6"><div class="card"><img class="card-img-top" src=\"'+(tabBook[l][0])+'" id="cimg" alt="Card image cap"><div class="card-body"><h5 class="card-title">'+(tabBook[l][1])+'</h5><p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p><p>Rate: '+(tabBook[l][3])+'</p><p>'+(tabBook[l][4])+' voters</p><button type="button" class="btn btn-info" onClick="like(this)">Like!</button></div></div></div>';
            }
        };
